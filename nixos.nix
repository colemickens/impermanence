  ...
  config = {
    ...
    system.activationScripts =
      let
        ...
        # using mkDirWithModeAndPerms to correctly replicate the directory
        # structure above it
        mkFileWithModeAndPerms = persistentStoragePath: file: ''
          (
        ...
        # mkDirWithModeAndPerms to correctly replicate the directory structure
        # above the symlink
        mkDirSymlink = persistentStoragePath: dir: ''
          # replicate the directory structure of ${dir}
          ${mkDirWithModeAndPerms persistentStoragePath (dirOf dir)}
        ...
        mkActivationScript = persistentStoragePath:
          nameValuePair
            ...
            (noDepEntry (concatString [
              ...
              (concatMapStrings
                (mkFileWithModeAndPerms persistentStoragePath)
                cfg.${persistentStoragePath}.bind.files
              )
